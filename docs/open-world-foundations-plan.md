...
|---|---|---|---|
| **0** | Reverse-Z + robust sky test; re-enable culling; (diagnostics already reverted) | The current broken render; far-field z-fighting | Small, Metal-only (user-verified) |
