#ifndef RAYTRACER_ENGINE_PROCGEN_CITY_ROADS_LANES_DECK_MESH_H
#define RAYTRACER_ENGINE_PROCGEN_CITY_ROADS_LANES_DECK_MESH_H
...
// pass's paving datum (block_audit.h lanesSidewalkRise) is the mesher's own number.
