...
const char* const kCityLotsBuildTag = "2026-09-17.1";   // .1: a lot that cannot clear the carriageway is green, not built from the raw site polygon   // .2: propagateWaterSeaLevel, so a level with water grows the loader's graph
