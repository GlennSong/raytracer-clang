#ifndef RAYTRACER_ENGINE_PROCGEN_LANELAB_CITY_PRODUCER_H
#define RAYTRACER_ENGINE_PROCGEN_LANELAB_CITY_PRODUCER_H
...
// graph references, the render cell size, sizeof(Real), kCityFormatVersion and kLanelabBuildTag — the tag
...
extern const char* const kLanelabBuildTag;
